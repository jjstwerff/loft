...
fn n_append(stores: &mut Stores, mut var_ch: i32, mut var___work_1: &mut String) -> Str { //block_1: text["__work_1"]
  *var___work_1 = "".to_string();
  Str::new({ //Add text_2: text["__work_1"]
    var___work_1.clear();
    *var___work_1 += "abc_de";
    {let c = var_ch; if c != 0 { var___work_1.push(ops::to_char(c)); } };
    var___work_1
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  n_assert(stores, (&var_test_value) == ("abc_dex"), _pre13, "append_fn", 6_i32);
  ;
  ;
  ;
  } /*block_1: void*/
