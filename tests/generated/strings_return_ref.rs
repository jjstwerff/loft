...
fn n_return_ref(stores: &mut Stores, mut var_a: &mut String) -> Str { //block_1: text["a"]
  *var_a = "12345".to_string();
  Str::new(return Str::new(OpGetTextSub(stores, var_a, 0_i32, 4_i32)))
  } /*block_1: text["a"]*/
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  let mut var_test_value = { //block_2: text
    n_return_ref(stores, &mut var___work_1)
  ...
  n_assert(stores, (&var_test_value) == ("1234"), _pre13, "return_ref", 9_i32);
  ;
  ;
  ;
  } /*block_1: void*/
