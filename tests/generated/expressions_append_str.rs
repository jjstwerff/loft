...
fn n_append(stores: &mut Stores, mut var_ch: i32, mut var_s: &mut String) -> Str { //block_1: text["s"]
  *var_s = "abc_de".to_string();
  {let c = var_ch; if c != 0 { var_s.push(ops::to_char(c)); } };
  Str::new(var_s)
  } /*block_1: text["s"]*/
...
fn n_test(stores: &mut Stores) { //block_1: void
  ...
  n_assert(stores, (&var_test_value) == ("abc_dex"), _pre13, "append_str", 6_i32);
  ;
  ;
  ;
  } /*block_1: void*/
