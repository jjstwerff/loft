...
//!
//! Adding a new native symbol becomes a single edit to `loft.toml`'s
//! `[native.functions]` table plus the `pub unsafe extern "C" fn n_<name>`
//! body in `src/lib.rs`.  The `loft_register!` list is no longer
//! hand-maintained.
