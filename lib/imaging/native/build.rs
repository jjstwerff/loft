...
//! @PLAN12 phase 2 Option A — delegates to the shared `loft-ffi-build`
//! crate so the TOML scanner + register-invocation emitter live in
//! exactly one place across all libraries.
//!
