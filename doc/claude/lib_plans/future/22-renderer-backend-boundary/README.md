...
[`../02-graphics/` § Native mobile backends](../02-graphics/README.md#native-mobile-backends-android--ios--evaluation-2026-05-25).
...
- **lib_plans/future/02-graphics** — this completes that plan's
...
- [`../02-graphics/README.md` § Native mobile backends](../02-graphics/README.md#native-mobile-backends-android--ios--evaluation-2026-05-25) — the evaluation that surfaced this prerequisite.
