...
The companion server-side library is `server` ([WEB_SERVER_LIB.md](../future/08-server/README.md)).
...
> **Superseded by [EVENT_LOOP.md](../../plans/32-event-loop/README.md).**  This
...
> [EVENT_PROTOCOL.md](../../plans/32-event-loop/PROTOCOL.md)) replaces the
> variant-tagged dispatch shown below.  See
> [EVENT_LOOP.md § three-tier registration](../../plans/32-event-loop/README.md#three-tier-registration)
