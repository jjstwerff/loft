...
Editing (E1) is OUT of scope — that's a follow-up @PLN66
...
- **E1 (single-file edit)** — adding a real editor framework
  (Monaco / CodeMirror); track as @PLN66 phase 07.
- **E2 (completion + signature help)** — @PLN66 phase 08.
- **E3 (refactoring + multi-file)** — @PLN66 phase 09.
- **Workspace symbol search** (Ctrl+P / Cmd+P palette) —
  E2 territory.

These are LISTED in the @PLN66 README's "Browser-side editor
