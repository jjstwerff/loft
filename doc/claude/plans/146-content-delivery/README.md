...
**14 of 18 shipped** (`E1` · `W0` · `W1` · `W2` · `W3` · `W4` · `F1` · `F2` · `F3` · `F4` · `F5` · `F6` · `F7a` · `F7`),
**none blocked**, 4 open — and **arc F really is complete now**: `F7` was still blocked when
...
- **Effort:** H — 18 phases in three arcs, none above M. **Design:** ✓. **`E1` shipped 2026-08-19; `W0` + `F7a` 2026-08-21; `F1` + `F2` + `F3` + `F5` + `F6` 2026-08-22; `F4` + `F7` + `W1` + `W2` 2026-08-23; `W3` + `W4` 2026-08-24.**
