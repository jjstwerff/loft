...
**Open — arc A complete, arc P four phases in (`stage` 0.10.0).** The runtime is not the gap: `loft --html` already
...
- **Effort:** MH — 18 phases in three arcs (`A3` split in two), **none above M**. **Arc A complete 2026-08-19**, `P1`–`P4` shipped; see § Effort per phase
...
| **P** presentation | `A3` | `P1` ✅ · `P2` ✅ · `P3` ✅ · `P4` ✅ · **`P5` next** → `P6` |
