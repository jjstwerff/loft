...
**Open — arcs A and P COMPLETE, `L1`+`L2` shipped (`stage` 0.14.0); `L3` remains.** The runtime is not the gap: `loft --html` already
...
- **Effort:** MH — 18 phases in three arcs (`A3` split in two), **none above M**. **Arcs A and P complete 2026-08-19**, `L1`+`L2` shipped; `L3` and `G` remain; see § Effort per phase
...
| **L** light | `A5`'s tint (`L1`), `A3` (`L2`/`L3`) | `L1` ✅ · `L2` ✅ → `L3` |
