...
**Open — arcs A, P and L are ALL COMPLETE (`stage` 0.15.0). Only `G` remains, deferred behind its trigger.** The runtime is not the gap: `loft --html` already
...
- **Effort:** MH — 18 phases in three arcs (`A3` split in two), **none above M**. **Arcs A, P and L all complete 2026-08-20**; only `G` remains, deferred; see § Effort per phase
...
| **L** light | ✅ **complete** | `L1`–`L3` all shipped as `stage` 0.15.0 |
