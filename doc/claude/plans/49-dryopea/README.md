...
# @PLN49 — dryopea: sci-fi free-build / tower-defence game

**Status:** **STALLED 2026-05-28** — development paused along with
moros and bumper-airplanes ([@PLN51](../51-bumper-airplanes/README.md))
...
[lib-plan 20 terrain height-map](../../lib_plans/71-terrain-heightmap/README.md)
