...
- **Source:** a saved dryopea editor MapFile (or future stencil-pipeline
  output — @PLAN46 plan 06).  The painted palette types map to extrusion
  rules:
...
- **One file format.**  MapFile JSON loaded via
  [`hex_world::load_mapfile()`](../../../../../lib/hex_world/MAPFILE.md) (the
...
| Static world load | Read a dryopea MapFile JSON OR a `store_persist_bind`'d hash, extrude per palette; serve as a single download to phone + projector at session start | Loader is [`hex_world::load_mapfile()`](../../../../../lib/hex_world/MAPFILE.md) (Phase 7a wraps the existing moros_map shape behind a documented schema); palette extrusion fields live on `MaterialDef.md_extrude` per the schema doc.  Stencil-pipeline supplement after @PLAN46 plan 06 lands |
...
| 2  | Static world loader — `hex_world::load_mapfile()` + per-palette extrusion (palette-`md_extrude` → 3D pillars / cliffs / ramps) | XS | [`lib/hex_world/MAPFILE.md`](../../../../../lib/hex_world/MAPFILE.md); @PLAN46 plan 01 E4 |
...
- [@PLAN46 dryopea](../46-dryopea/README.md) — editor that authors
...
- [`lib_plans/future/26-physics-2body/`](../../../lib_plans/future/26-physics-2body/README.md)
  — shared rigid-body physics; sub-arc 4 consumes Phases 1-5.
- [`lib_plans/future/27-particles/`](../../../lib_plans/future/27-particles/README.md)
...
- [`lib_plans/future/08-server/` § Gap 8](../../../lib_plans/future/08-server/README.md#gap-8--per-recipient-broadcast-qos-sight--rate-lod--forecast)
  ...
  sub-arc 7 consumes.
- [`lib/hex_world/MAPFILE.md`](../../../../../lib/hex_world/MAPFILE.md) —
