# WASM file I/O — FS-A…F implementation steps (archived)

**Status: shipped (W1.16).** Step-by-step plan for WASM file I/O, kept for
reference. The runtime/reference docs live in [WASM.md](../../../WASM.md).
