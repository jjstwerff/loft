...
[
  ...
  {"file": "doc/claude/plans/finished/35-branch-review-viewer/README.md", "line": 99,
   "anchor": "drivers",
   "context": "...uses [plan-22 closures](../future/finished/22-mutable-closures/README.md#drivers)..."},
  ...
]
```
...
| `tools/indexer/scan.loft` (@PLN42 phase 07) | EXTEND when ported: same extractor + bucket |
