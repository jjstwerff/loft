...
DAP server (LSP.3 in [LSP.md](../../lib_plans/63-lsp/README.md)) — that's the right tool when
...
- [LSP.md](../../lib_plans/63-lsp/README.md) — LSP.1 / LSP.2 / LSP.3 design.  LSP.3's DAP server
