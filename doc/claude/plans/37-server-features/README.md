...
- [`lib_plans/future/08-server/`](../../lib_plans/future/08-server/README.md) — server library design + game server additions
- [GAME_CLIENT_LIB.md](../../lib_plans/64-game-client/README.md) — game client library design
