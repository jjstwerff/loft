...
| [`10-scope-exit-emission/`](10-scope-exit-emission/) | Scope-exit emission rewrite — replaces dep-tracking-driven OpFreeRef emission with mechanical scope-walk + runtime no-op fast-path + Drop safety net.  Closes P203 and cleanup-side of P204 without touching the fragile dep-tracking system.  Sibling of plan 09 (complementary; either order works). | Phase 00 (survey) open |
