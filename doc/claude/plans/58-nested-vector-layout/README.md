...
| boolean | Outer vector-of-vectors **handle stride** = inner scalar size (1) not 4 → handles overlap | corruption→crash | both | **cluster-I root — fix PENDING** (3 attempts journaled in RESULTS.md) | (see RESULTS.md) |
