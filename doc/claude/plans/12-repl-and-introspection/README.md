...
| **INSP.J** | JSON output mode for `loft introspect` (machine-readable, for IDE integration).  **Routed to [`lib_plans/future/09-lsp/`](../../lib_plans/future/09-lsp/README.md)** — it is an IDE/LSP concern, tracked there as an open-work row. |
