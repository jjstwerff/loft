...
# @PLN33 — MULTIPLAYER_EDITOR — minimal multi-client hex editor (real-game milestone)
...
[TIC_TAC_TOE.md](../39-tic-tac-toe/README.md), it does not replace them:
...
- [TIC_TAC_TOE.md](../39-tic-tac-toe/README.md) — protocol validator (v1
  shipped); v2/v3 are deferred to focus this milestone instead.
- [EVENT_PROTOCOL.md](../32-event-loop/PROTOCOL.md) — wire format spec.
- [EVENT_LOOP.md](../32-event-loop/README.md) — full event-loop spec; this
