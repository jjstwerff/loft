...
Status: **design, not implemented.**  Regex (see [REGEX.md](lib_plans/future/01-regex/README.md))
...
- **Library upgrades become invisible.**  Swapping the regex engine
  ...
  [REGEX.md](lib_plans/future/01-regex/README.md)) does not change the user's source.
...
3. **Ship regex (see [REGEX.md](lib_plans/future/01-regex/README.md)) as the first new consumer.**
...
- [REGEX.md](lib_plans/future/01-regex/README.md) — regex library design; the first lazy consumer.
