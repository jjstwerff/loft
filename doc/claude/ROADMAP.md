...
| **Stability instruments** | program-level fuzzing (`@PLN53`) — **✅ harness shipped + CLOSED**; sanitizer-coverage expansion (`@PLN54`) — mostly shipped, S9 cdylib-boundary ASan open | 53 closed · 54 open (S9) | STABILITY_ROADMAP step 9; plans 53/54 |
