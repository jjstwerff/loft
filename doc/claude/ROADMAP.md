...
| (cross) | Startup cache — cache compiled `default/` stdlib so it isn't re-parsed every run (parse ≈ 90% of cold-start) | M | ✓ | plans/deferred/28-const-store/STARTUP_CACHE_PLAN.md |
