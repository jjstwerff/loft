...
Real apps built with loft — reference examples of HOW to build such things, not installable components. The set is curated; each external app's info is fetched live. Community showcases may join over time (see @PLN112).
