...
| Item | Section | Status |
|---|---|---|
| **Dep-inference** — for native fn returns (zero-leak unblock) | [§ Active design — Dep-inference](#active-design--dep-inference-for-native-fn-returns-zero-leak-unblock) | Closes closure / native-fn dep-tracking gap; cooperates with `plans/21-retire-scratch/` |
