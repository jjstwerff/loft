...
**Pattern**: 3 of 6 open issues (P240 / P241 / P243) are in
...
type-variable substitution).  The other 2 (P250, P251) are
tuple-of-non-trivial-element bugs around per-element projection
in storage and lifetime.
